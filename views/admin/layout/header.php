...
<head>
    ...
    <script src="<?php echo RootREL; ?>media/libs/js/Underscore-1.8.3.js"></script>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo RootREL; ?>media/img/user2-160x160.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $this->fullname; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                ...
                <p>
                  <?php echo $this->fullname; ?> - Web Developer
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo vendor_app_util::url(['ctl'=>'login','act'=>'logout']); ?>" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p class="name-admin"><?php echo $this->fullname; ?></p>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="<?php echo vendor_app_util::url(array('ctl'=>'dashboard')); ?>">
